      ...
      var gameOver, restart;
        ...
        //set collider for mainCyclist
           ...
           mainCyclist.setCollider("rectangle",0,0,500,100)
          ...
          if(pinkCG.isTouching(mainCyclist))
        {
         ...
         // mainCyclist.changeAnimation("mainCyclist",mainRacerImg2)
        }
          ...
          if(yellowCG.isTouching(mainCyclist))
        {
         ...
         // mainCyclist.changeAnimation("mainCycle",mainRacerImg2)
        }
        ...
        //  mainCyclist.changeAnimation("mainBicycle",mainRacerImg2)
        }
